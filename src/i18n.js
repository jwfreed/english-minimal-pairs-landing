...
const baseTranslations = {
  ...
  'idioma español': {
    name: 'Español',
    flag: '🇪🇸',
    navCta: 'Acceso de por Vida',
    heroBadge: 'Ciencia para tu Éxito',
    heroTitle: 'Domina el Inglés, Asegura tu Futuro: El Secreto de la Confianza Empieza en tus Oídos',
    heroHighlight1: '"Ship"',
    heroHighlight2: '"Sheep"',
    heroSubtitle: 'No dejes que los sonidos que no escuchas limiten tu carrera profesional. Soundwise utiliza ciencia de vanguardia para que finalmente logres esa pronunciación perfecta que te abrirá puertas en todo el mundo.',
    ...
    ctaPrimary: 'Obtén Acceso de por Vida por solo $4.99',
    ...
    solutionTitle: 'Entrena tu oído, la confianza vendrá sola',
  solutionDescription: 'Soundwise entrena tu cerebro para crear nuevas conexiones neuronales y "desbloquear" sonidos antes invisibles. Practica sin la presión de hablar y gana seguridad real.',
    feature1: 'Sin presión de hablar - Aprende a tu ritmo, sin vergüenza',
    feature2: 'Basado en Neuroplasticidad - Crea nuevas conexiones cerebrales',
    feature3: 'Feedback Instantáneo - Acelera tu aprendizaje 3x',
    feature4: 'Dificultad adaptativa - Se enfoca en tus desafíos (V vs B, vocales)',
    feature5: 'Mobile-First - Practica en el bus o en el trabajo (auriculares)',
    
    howItWorksTitle: 'Cómo Funciona',
    howItWorksSubtitle: 'Tres pasos simples para mejorar la percepción de pronunciación',
    step1Title: 'Escuchar',
    step1Text: 'Escucha una palabra o sonido que desafía a los hispanohablantes',
    step2Title: 'Elegir',
    step2Text: 'Selecciona qué palabra escuchaste de un par mínimo (ej. "ship" o "sheep")',
    step3Title: 'Aprender',
    step3Text: 'Obtén retroalimentación instantánea y recablea tu cerebro',
    
    progressBadge: 'Rastrea Tu Mejora',
    progressTitle: 'Mide tu Éxito en Tiempo Real',
    progressDescription: 'Gráficos en tiempo real que muestran cómo tu cerebro crea nuevas vías neuronales. Observa cómo tu comprensión sube mientras dominas los sonidos difíciles.',
    progressFeature1: 'Tendencias de precisión - Ve tu mejora con gráficos detallados',
    progressFeature2: 'Objetivos de práctica - Apunta a 60 minutos por par para la maestría',
    progressFeature3: 'Múltiples pares - Practica contrastes específicos (V vs B, th vs s)',
    progressFeature4: 'Guardado automático - Tu progreso se guarda automáticamente',
    ...
    featureCard1Title: 'Personalizado para ti',
    featureCard1Text: 'Se enfoca en "puntos ciegos" hispanos: V vs B, th vs z, vocales',
    featureCard2Title: 'Múltiples Idiomas',
    featureCard2Text: 'Interfaz totalmente en español para aprender sin barreras',
    featureCard3Title: 'Audio Profesional',
    featureCard3Text: 'Elige acento estadounidense o británico para una inmersión auténtica',
    featureCard4Title: 'Mide tu Éxito',
    featureCard4Text: 'Gráficos en tiempo real que muestran tu evolución neuronal',
    featureCard5Title: 'Sesiones de 15 Minutos',
    featureCard5Text: 'Diseñado para el profesional ocupado. Aprovecha cada minuto',
    featureCard6Title: 'Auto-Guardado',
    featureCard6Text: 'Tus resultados se guardan automáticamente. Relájate y aprende',
  ...
  faq4Answer: '¡Absolutamente! Soundwise es el "gimnasio para tus oídos" que hace que el resto de tu inglés (Duolingo, clases) funcione mejor.',
    ...
    ctaTitle: '¿Listo Para Hablar Inglés con Total Seguridad?',
  ctaSubtitle: 'Obtén acceso de por vida por solo $4.99.',
    ...
    footerTagline: 'Ciencia aplicada para que el mundo te entienda.',
  ...
  'ภาษาไทย': {
    ...
    heroHighlight1: '"Right"',
    heroHighlight2: '"Light"',
    heroSubtitle: 'เรียนรู้อย่างชาญฉลาดด้วยวิทยาศาสตร์การรับรู้เสียงที่พิสูจน์แล้ว — ให้คุณได้ยินเสียงที่เคย "พลาด" ไป โดยไม่ต้องใช้ไมโครโฟน',
    ...
    problemTitle: 'ทำไมคนไทยหลายคนถึงพูดภาษาอังกฤษไม่ชัด?',
    problemSubtitle: 'ปัญหาไม่ได้อยู่ที่ความพยายาม แต่อยู่ที่ "สมอง" ของคุณยังไม่ได้ถูกฝึกให้แยกแยะเสียงที่ไม่มีอยู่ในภาษาไทย',
    ...
    insightText: 'แอปทั่วไปเน้นให้คุณ "พูดตาม" แต่ในความเป็นจริง คุณไม่สามารถออกเสียงสิ่งที่คุณ "ไม่ได้ยิน" ได้ หูของคุณต้องเรียนรู้วิธีแยกแยะเสียงเหล่านี้ก่อน การพูดที่ชัดเจนจึงจะตามมาเองอย่างเป็นธรรมชาติ',
    
    solutionBadge: 'วิธีแก้ปัญหา',
    solutionTitle: 'ฝึกหูให้เก่งก่อน แล้วการพูดจะง่ายขึ้น',
  solutionDescription: 'Soundwise ใช้การฝึกฟังที่ออกแบบมาโดยเฉพาะเพื่อ "ปรับจูนสมอง" ในสมองของคุณใหม่ ผ่านการเปรียบเทียบเสียงเชิงกลยุทธ์ที่คุณจะรู้สึกเหมือนการเล่นเกม',
    feature1: 'ฟังและเปรียบเทียบ - เน้นการฟังอย่างเดียว ไม่ต้องกดดันเรื่องการพูด',
    feature2: 'รวมสัญกรณ์ IPA - ดูสัญลักษณ์ทางสัทศาสตร์ที่แม่นยำสำหรับแต่ละเสียง',
    feature3: 'เห็นผลทันที - รู้ทันทีว่าเลือกถูกหรือผิด เหมือนมีครูส่วนตัวอยู่ข้างๆ',
    feature4: 'ปรับความยากตามตัวคุณ - ระบบจะเน้นเสียงที่คุณยังทำไม่ได้ ช่วยให้ประหยัดเวลา',
    feature5: 'ฝึกได้ทุกที่ - แค่มีหูฟังก็เก่งได้ ไม่ว่าจะบนรถไฟฟ้าหรือรอคิวเช็กอิน',
    ...
    progressBadge: 'ติดตามความคืบหน้า',
    progressTitle: 'เก่งขึ้นทุกวันที่ฝึก: ติดตามความสำเร็จแบบเรียลไทม์',
    progressDescription: 'ดูสมองของคุณสร้างเส้นทางประสาทใหม่ผ่านแผนภูมิที่เข้าใจง่าย<br>เหมือนการอัปเลเวลในเกมที่ทำให้คุณภูมิใจทุกครั้งที่เห็นสถิติตัวเองดีขึ้น',
    progressFeature1: 'แนวโน้มความแม่นยำ - เห็นพัฒนาการที่จับต้องได้ด้วยกราฟแสดงความก้าวหน้า',
    progressFeature2: 'เป้าหมายการฝึก - มุ่งสู่เป้าหมาย 60 นาทีต่อคู่เสียง เพื่อความแม่นยำขั้นเทพ',
    progressFeature3: 'ฝึกได้หลายคู่เสียง - เลือกฝึกเสียงที่ท้าทายคุณมากที่สุดและติดตามผลแยกกันได้ทันที',
    progressFeature4: 'บันทึกอัตโนมัติ - หมดกังวลเรื่องข้อมูล เราเซฟให้คุณทุกก้าว',
  ...
  faq4Answer: 'ได้แน่นอน! Soundwise คือ "อาวุธลับ" ที่ช่วยให้การเรียนในห้องเรียนหรือแอปอื่นๆ ของคุณได้ผลดียิ่งขึ้นอย่างก้าวกระโดด',
    ...
    ctaTitle: 'พร้อมที่จะเปลี่ยน "หู" ของคุณให้เป็น "หูเทพ" หรือยัง?',
  ctaSubtitle: 'ปลดล็อกความสามารถทางการได้ยินตลอดชีพ ในราคาเพียง $4.99 (ประมาณ 170 บาท)',
    appStore: 'App Store',
    googlePlay: 'Google Play',
    ...
    footerTagline: 'นวัตกรรมฝึกฟังภาษาอังกฤษที่ได้รับการรับรองทางวิทยาศาสตร์ เพื่อผลลัพธ์ที่วัดได้จริงสำหรับคนไทย',
  ...
  '한국어': {
    ...
    heroHighlight1: '"Right"',
    heroHighlight2: '"Light"',
    heroSubtitle: '과학으로 재설계하는 듣기 훈련. 한국인 학습자들이 겪는 발음 고민의 핵심은 ‘노력’이 아닌 ‘청각 모델링’의 부재입니다. 마이크 없이 오직 듣기 훈련만으로 모국어(한국어)에 존재하지 않는 영어의 미세한 음역대를 마스터하세요.',
  ...
  solutionDescription: '치열한 대한민국 취업 시장과 글로벌 비즈니스 환경에서 영어 숙련도는 단순한 스펙을 넘어선 경제적 보상으로 이어집니다.',
    ...
    feature2: '<b>완벽주의의 함정:</b> 한국인은 완벽한 문법에 집착하여 실수를 두려워합니다. Soundwise는 리스닝을 통해 자신감을 쌓아 실수에 대한 두려움을 제거합니다.',
    feature3: '',
    feature4: '',
    feature5: '',
