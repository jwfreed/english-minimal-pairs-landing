...
const baseTranslations = {
  ...
  solutionDescription: 'Soundwise ใช้การฝึกฟังที่ออกแบบมาโดยเฉพาะเพื่อ "เชื่อมต่อเส้นทางประสาท" ในสมองของคุณใหม่ ผ่านการเปรียบเทียบเสียงเชิงกลยุทธ์ที่คุณจะรู้สึกเหมือนการเล่นเกม',
    ...
    progressDescription: 'ดูสมองของคุณสร้างเส้นทางประสาทใหม่ผ่านแผนภูมิที่เข้าใจง่าย เหมือนการอัปเลเวลในเกมที่ทำให้คุณภูมิใจทุกครั้งที่เห็นสถิติตัวเองดีขึ้น',
